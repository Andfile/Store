...
public class AddToCartFragment extends Fragment {
    ...
    //todo подумать как изменить эту ситуацию
    //todo проблемы, если оставить эту реализацию то надо в ручную прописать все варианты при смене орентации

    //todo реализовать передачу данных для прорисовки лейаунта через аргументы бандла.
